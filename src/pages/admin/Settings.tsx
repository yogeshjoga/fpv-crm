        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <BrandingSlot
              ...
              url={org.cert_background_url}
              busy={uploading === 'cert_background_url'}
              onFile={(f) => uploadBranding('cert_background_url', f)}
            />
            <p className="mt-1.5 text-xs text-neutral-500">
              Full certificate artwork (logo, borders, signature) as one PNG or JPG — certificates are generated by
              printing the student's name, certificate type and ID directly on top of this image.
            </p>
          </div>
        </div>
      </GlassCard>
